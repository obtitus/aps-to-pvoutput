ECU_ID = '<INSERT ECU ID>'
PV_OUTPUT_SYSTEMID = '<INSERT pvoutput.org system id (found in url of your system)>'
PV_OUTPUT_APIKEY = '<INSERT pvoutput.org api key>'
OPENWEATHER = '<INSERT openweather api key>' # Register for free and find at https://home.openweathermap.org/api_keys
